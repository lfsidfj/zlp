		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="contracttype/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="CONTRACTTYPE_ID" id="CONTRACTTYPE_ID" value="${pd.CONTRACTTYPE_ID}"/>
						<input type="hidden" name="PARENT_ID" id="PARENT_ID" value="${null == pd.PARENT_ID ? CONTRACTTYPE_ID:pd.PARENT_ID}"/>
