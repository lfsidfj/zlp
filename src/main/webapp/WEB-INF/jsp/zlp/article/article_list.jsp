						...
						<table style="margin-top:5px;">
							<tr>
								...
								<td style="vertical-align:top;padding-left:2px;">
									<select class="chosen-select form-control" name="ARTICLE_CATEGORY_ID" id="ARTICLE_CATEGORY_ID" data-placeholder="请选择文章类目" style="vertical-align:top;width: 130px;">
										<option value=""></option>
										<option value="">全部</option>
										<c:forEach items="${categoryList}" var="var" varStatus="vs">
											<option value="${var.ARTICLE_CATEGORY_ID}" <c:if test="${var.ARTICLE_CATEGORY_ID ==pd.ARTICLE_CATEGORY_ID}">selected="selected"</c:if>>${var.CATEGORY_NAME}</option>
										</c:forEach>
									</select>
								</td>
								<c:if test="${QX.cha == 1 }">
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.ARTICLE_NAME}</td>
											<td class='center'>${var.CATEGORY_NAME}</td>
											<td class='center'>${var.SEQENCE}</td>
											<td class='center'>
												<c:if test="${var.IS_SHOW=='0'}">展示</c:if>
												<c:if test="${var.IS_SHOW=='1'}">不展示</c:if>
											</td>
