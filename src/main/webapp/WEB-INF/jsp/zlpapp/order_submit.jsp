				...
				<div id="flow-cont-height" >
					...
					<section class="flow-checkout-select b-color-f m-top08">
						...
						<p class="padding-all f-05 text-right t-remark">
							共 ${pd.goodsSize } 件商品，合计：<span class="t-first" id="ru_amount0">¥${pd.content }</span>&nbsp;&nbsp;&nbsp;优惠：<span class="t-first" id="ru_amount0">¥${pd.discount }</span>
						</p>
					</section>
				...
				window.WebViewJavascriptBridge.send(
		               ...
		               , function(responseData) {
		            	   ...
		            	   if(obj.type=="success" || obj.type=="fail"){
		            		   ...
		            		   window.location.replace("<%=basePath%>lshapp/shop/index.do");
		            	   }
