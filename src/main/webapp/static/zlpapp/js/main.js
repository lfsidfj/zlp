...
/*
function initialYMD(Y,M,D){
	tY=Y;
	tM=M;
	tD=D;
	initial();
}*/
function getYMDAndHide(){
	var birthday=$("#content span").first().text();

	birthday=birthday.slice(0,9).trim();
	$("#BIRTHDAY").val(birthday);
	$(".birthday font").html(birthday);

	birthday=birthday.slice(0,10).trim();
	$(".birthday").val(birthday);
