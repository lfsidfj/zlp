package com.szjm.controller.zlp.activity;
...
public class ActivityController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("zlp/activity/activity_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("zlp/activity/activity_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).getString("ACTIVITY_NAME"));	    //1
			vpd.put("var2", varOList.get(i).get("SEQENCE").toString());	//2
